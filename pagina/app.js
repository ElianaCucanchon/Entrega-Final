...
const pintarCards = data => {
    data.forEach(producto => {
        ...
        templateCard.querySelector('img').setAttribute("src", producto.img) //Cambio de Thumberlina a img
...
const pintarFooter = () => {
    ...
    if(Object.keys(carrito).length  === 0) {
        footer.innerHTML =`
        <th scope="row" colspan="5">Carrito vacío - comience a comprar! Gracias por preferirnos!!</th>
        `
        return
    }
